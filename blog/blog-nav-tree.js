...
(function () {
  ...
  function injectStyles() {
    var css = ''
      ...
      + 'background:#fff;border-right:2px solid #dde8c8;padding:18px 14px 40px;z-index:150;'
      ...
      + '.blog-tree-backdrop{position:fixed;inset:0;background:rgba(20,30,15,0.35);z-index:149;'
      + 'display:none;}'
